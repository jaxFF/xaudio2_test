...
REM MIT License Copyright (c) 2019 Agustin Van Dott
REM Forked from https://github.com/desvandev/faster-vcvars
REM Modified by Jaxon Laing (jaxne@jaxne.xyz) to include devenv
